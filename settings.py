...
PARTICIPANT_FIELDS = ['roleID', 'isObserver', 'isParticipating', 'informed', 'treatment', 'framing', 'endowment_type', 'good_preference', 'unused_assets_endofround', 'co2_certificate_trust', 'finished']
